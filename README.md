...
75 страниц и 4 перенаправления. Формы не отправляют и не сохраняют данные. Сервер Node.js, почтовая доставка, административная панель, чат-бот и аналитика здесь не запускаются. Внешние карты и ссылки требуют интернета.
